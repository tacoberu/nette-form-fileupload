...
// JS auto-fires preload on file input change; waitForNavigation must start before setInputFiles.
const uploadFiles = (page: Page, files: string | string[]) => Promise.all([
	page.waitForNavigation({ waitUntil: 'load' }),
	page.setInputFiles(a2.file, files),
]);
